...
/**
 * An ApplicationScoped CDI bean.
 * This bean observes inbound events from the CDI event bus and then pushes
 * the stock object down each registered WebSocket session as a JSON String representation
 * 
