...
@WebFilter(filterName = "TestFilter", urlPatterns = {"/*"}, initParams = {
    @WebInitParam(name = "FilterInit1", value = "Test")})
public class TestFilter implements Filter {
    ...
    private void doBeforeProcessing(ServletRequest request, ServletResponse response)
        ...
        request.setAttribute("Filter1", "Test");
        request.setAttribute("Filter2", filterConfig.getInitParameter("FilterInit1"));
        request.setAttribute("FilterAppInject", appBean.doIExist());
        request.setAttribute("FilterSInject", sessBean.doIExist());
        request.setAttribute("FilterRInject", reqbean.doIExist());
        request.setAttribute("FilterEJBInject", ejbBean.doYouExist());
