...
/**
 * EJB clustered singleton with all possible annotation parameters
 *
 * @author lprimak
 */
@Clustered(callPostConstructOnAttach = false, callPreDestoyOnDetach = false,
        keyName = "ComplexExampleEJB", lock = DistributedLockType.LOCK_NONE)
@Singleton
public class WithAllParametersEJB implements Serializable {
    /**
